const About = () => {
    return (
    <section className="w-full 2xl:h-screen mx-auto bg-beige text-darkolive flex flex-col justify-center items-center gap-y-4">
        <h1 className="text-[8vh] font-[500]">Hi I'm Najat and I'm a Developer.</h1>
